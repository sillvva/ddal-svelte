...
>
	...
	>
		...
		<DatePicker.Trigger class="ml-auto inline-flex items-center justify-center">
			<span class="mdi--calendar iconify size-6" />
		</DatePicker.Trigger>
	</DatePicker.Input>
	<DatePicker.Content class="z-[10000] mt-2">
		<DatePicker.Calendar let:months let:weekdays class="shadow-popover rounded-lg border border-base-300 bg-base-200 p-[22px]">
			<DatePicker.Header class="flex items-center justify-between">
				<DatePicker.PrevButton class="mdi--chevron-left iconify inline-flex size-10 items-center justify-center transition-all" />
				<DatePicker.Heading class="text-lg" />
				<DatePicker.NextButton
					class="mdi--chevron-right iconify inline-flex size-10 items-center justify-center transition-all"
				/>
			</DatePicker.Header>
