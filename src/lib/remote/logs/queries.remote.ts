...
export const getCharacterLogForm = guardedQuery(characterLogFormSchema, function* (input, { user }) {
...
export const getDMLogForm = guardedQuery(dmLogFormSchema, function* (input, { user }) {
	const Logs = yield* LogService;
